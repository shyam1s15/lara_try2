...
<div id="grad1">
    <div class="container">
        ...
        <form action="insertRoom" method="POST" style="margin : auto ">
            ...
            <div class="form-group" >
                <label ><img src="{{ url('/img/cal.png') }}" height="30px" alt="" style="margin-right:10px">Date of Birth</label>
                <input type="date" class="form-control" name="no" required placeholder="Enter your Bithdate">
            </div>

            <div class="form-group">
                <label><img src="{{ url('/img/name34.png') }}" height="30px" alt="" style="margin-right:10px">Age</label>
        ...
        <div class="form-group" >
            ...
            <div class="form-group" >
                <label ><img src="{{ url('/img/occu.png') }}" height="30px" alt="" style="margin-right:10px">occupation</label>
                <input type="text" class="form-control" placeholder= "work of worker">
            </div>

            <div class="form-group">
            <label> <img src="{{ url('/img/sal.png') }}" height="30px" alt="" style="margin-right:10px">salary</label>
            ...
            <input type="reset" value="Reset" class="btn" style="background-color : blue; color:white; margin : 20px" >
            </div>
        </form>
        </div>
    </div>
